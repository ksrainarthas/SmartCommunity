 ...
 * @author Lee
 */
public class VerticalDividerItemItemDecoration extends BaseDividerItemDecoration {

    private MarginProvider mMarginProvider;

    protected VerticalDividerItemItemDecoration(Builder builder) {
        super(builder);
    ...
    public static class Builder extends BaseDividerItemDecoration.Builder<Builder> {
        ...
        public VerticalDividerItemItemDecoration build() {
            checkBuilderParams();
            return new VerticalDividerItemItemDecoration(this);
        }
    }
}